...
export const LEGAL_UI_TEXTS: Record<LegalTextKey, Record<AppUiLanguage, string>> = {
  ...
  privacyUpdated: {
    DE: "Letzte Aktualisierung: 06.05.2026",
    EN: "Last updated: 2026-05-06",
    IT: "Ultimo aggiornamento: 06.05.2026",
    TR: "Son güncelleme: 06.05.2026",
    SQ: "Përditësimi i fundit: 06.05.2026",
    KU: "Dawiya nûkirinê: 06.05.2026",
    RO: "Ultima actualizare: 06.05.2026",
  },
  termsTitle: {
...
export const KALENDER_DICTIONARY: Record<KalenderTextKey, Record<AppUiLanguage, string>> = {
  ...
  syncToEntry: {
    DE: " In Eintrag syncen",
    EN: " Sync to entry",
    IT: " Sincronizza in registrazione",
    TR: " Kayda aktar",
    SQ: " Sinkronizo te regjistrimi",
    KU: " Bi tomarê re hevrêz bike",
    RO: " Sincronizează în înregistrare",
  },
  documents: {
    DE: " Dokumente",
    EN: " Documents",
  ...
  scopeHint: {
    DE: "Bei mehrtägigem Urlaub werden Samstage, Sonntage und gesetzliche Feiertage in Baden-Württemberg automatisch nicht mitgezählt.",
    EN: "For multi-day vacation, Saturdays, Sundays, and public holidays in Baden-Württemberg are automatically not counted.",
    IT: "Per ferie di più giorni, sabati, domeniche e festività legali in Baden-Württemberg non vengono conteggiati automaticamente.",
    TR: "Birden fazla günlük izinlerde cumartesi, pazar ve Baden-Württemberg’deki resmî tatiller otomatik olarak sayılmaz.",
    SQ: "Për pushimet disa ditore, të shtunat, të dielat dhe festat zyrtare në Baden-Württemberg nuk llogariten automatikisht.",
    KU: "Di bêhnvedanên pirrojan de şemî, yekşem û cejnên fermî li Baden-Württemberg bixweber nayên hesibandin.",
    RO: "Pentru vacanța de mai multe zile, sâmbetele, duminicile și sărbătorile legale din Baden-Württemberg nu sunt numărate automat.",
  },
  fullVacationDay: {
